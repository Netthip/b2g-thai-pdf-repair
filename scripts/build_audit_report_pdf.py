...
def main():
    ...
    page.insert_textbox(
        ...
        "• รอบ 2: ซูมตรวจหัวข้อ/แถบสีครบ 365 บรรทัด → พบเพี้ยน 1 (TH-001) เท่านั้น\n"
        "• เหลือเพียง body text ที่แนะนำพิสูจน์อักษรโดยมนุษย์ ก่อนรับรอง \"0 errors\" อย่างเป็นทางการ",
