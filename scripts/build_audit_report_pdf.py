...
def main():
    ...
    page.insert_textbox(
        box,
        "• เอกสารทำมาดี ภาษาไทย render ถูกต้องเกือบทั้งเล่ม\n"
        "• พบข้อผิดพลาดยืนยันแล้ว 1 จุด (หัวเรื่องหน้า 66) ซึ่งสำคัญเพราะเป็นหัวเรื่องหมวด\n"
        "• ยังประกาศ \"0 errors\" ไม่ได้: TH-001 พิสูจน์ว่าการตรวจเต็มหน้าอาจตกหล่นอักขระเพี้ยน\n"
        "  ระดับกลิฟ จึงต้องทำรอบ 2 (ซูมหัวข้อทุกแถบ) + พิสูจน์อักษรโดยมนุษย์ ก่อนรับรอง",
