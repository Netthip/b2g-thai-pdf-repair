...
CONFIRMED = [
    ...
    },
    {
        ...
        "ข้อความที่พบ": "ตัวเลขล้านบาทแสดง 0-2 ทศนิยม (เช่น 69,078.7) — ไม่เป็นมาตรฐาน 4 ตำแหน่ง; รวม 251/252 จุดไม่ครบ 4 ทศนิยม",
        ...
        "วิธีตรวจพบ": "ดึงเลขจาก text layer + แยกหน่วยจาก OCR (ดู B2G_Numbers_Audit.xlsx); ผลรวมตรงทุกหน้าที่ตรวจ → ค่าถูก แต่รูปแบบผิด",
        "สถานะ": "มีตารางครบ 453 จุด + รูปแบบที่ถูก; รอจัดรูปแบบลง PDF (เริ่มแล้ว: ตัวอย่างหน้า 22)",
    },
    {
        "Issue ID": "TH-001",
        "รอบตรวจ": ROUND,
