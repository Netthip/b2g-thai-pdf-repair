...
CONFIRMED = [
    ...
    },
    {
        "Issue ID": "DATA-001",
        "รอบตรวจ": 5,
        "หน้า PDF": "ทั้งเล่ม (ตัวเลขล้านบาท)",
        "หน้าที่พิมพ์": "ทั้งเล่ม",
        "ลำดับบรรทัด/ตำแหน่ง": "ตัวเลขงบประมาณหน่วยล้านบาท 252 จุด",
        "ตำแหน่ง/หัวข้อ": "รูปแบบทศนิยมของตัวเลขล้านบาท",
        "ข้อความที่พบ": "ตัวเลขล้านบาทแสดง 0-2 ทศนิยม (เช่น 69,078.7) — ไม่เป็นมาตรฐาน 4 ตำแหน่ง",
        "ข้อความที่ควรเป็น": "รูปแบบ #,##0.0000 (4 ทศนิยม + comma) เช่น 69,078.7000 (ใช้ค่าเดิม ไม่แก้ค่า)",
        "ประเภทข้อผิดพลาด": "รูปแบบตัวเลข (ทศนิยมไม่ครบ 4 ตำแหน่งตามมาตรฐานล้านบาท)",
        "ความรุนแรง": "สูง (ผู้ใช้/สำนักงบประมาณยืนยันมาตรฐาน)",
        "วิธีตรวจพบ": "ดึงเลขจาก text layer + แยกหน่วยแบบ nearest-keyword จาก OCR (กัน ล้านคน/พันล้านบาท/บาทต่อคน/GDP); ดู B2G_Numbers_Audit.xlsx",
        "สถานะ": "453 จุด: ล้านบาท 149 จุด → จัด 4 ทศนิยมลง PDF แล้ว 148 จุด (fit-to-box ไม่ทับ layout, รวม badge/ตาราง/inline/เลขก้อนใหญ่); กัน ล้านคน/ไร่/ครั้ง/พันล้านบาท/บาทต่อคน ถูกต้อง; เหลือ ~114 จุดให้ตรวจทาน (กำกวม/OCR ไม่จับ เช่น 151,520)",
    },
    {
        "Issue ID": "TH-001",
        "รอบตรวจ": ROUND,
